...
public class AddEmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_ems);
        setTitle("의료진 추가");
        context = this;
            ...
            switch(v.getId()){
                case R.id.add:          //추가 버튼
                    ...
                    if(id.equals("") || pw.equals("") || pwCh.equals("") || name.equals("") || resident_id.equals("")
                        ...
                        if(pw.equals(pwCh)){
                            try {
                                String result = new CustomTask().execute(id,pw,name,resident_id,phone,"ems","join").get();
